    ...
    >
            ...
            <div className="bg-white rounded-3xl p-8 max-w-lg w-full shadow-2xl animate-fadeIn">
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-bold text-slate-800">Ready to Launch Together?</h2>
                </div>
                <button
              ...
              <div className="space-y-6 text-slate-600">
                <div className="text-center">
                  ...
                  <p className="text-lg text-slate-700">
                    I'm not just another developer - I'm your next <strong>secret weapon</strong> for building fintech products that users love! 💪
                  </p>
                </div>
                
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-3 bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl border border-purple-200 transform hover:scale-105 transition-all duration-300 animate-fadeInUp" style={{animationDelay: '0.1s'}}>
                    <div className="text-2xl animate-spin-slow">⚡</div>
                    <div>
                      <div className="font-semibold text-slate-800">6+ Years of Flutter Mastery</div>
                      <div className="text-sm text-slate-600">Building apps that handle millions in transactions</div>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-4 p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 transform hover:scale-105 transition-all duration-300 animate-fadeInUp" style={{animationDelay: '0.2s'}}>
                    <div className="text-2xl animate-bounce">💰</div>
                    <div>
                      <div className="font-semibold text-slate-800">Fintech & Crypto Expert</div>
                      <div className="text-sm text-slate-600">Secured $1M+ in real-world transactions</div>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-4 p-3 bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl border border-orange-200 transform hover:scale-105 transition-all duration-300 animate-fadeInUp" style={{animationDelay: '0.3s'}}>
                    <div className="text-2xl animate-pulse">🌍</div>
                    <div>
                      <div className="font-semibold text-slate-800">Remote-First Mindset</div>
                      <div className="text-sm text-slate-600">Timezone flexible, collaboration ready</div>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-4 p-3 bg-gradient-to-r from-pink-50 to-rose-50 rounded-xl border border-pink-200 transform hover:scale-105 transition-all duration-300 animate-fadeInUp" style={{animationDelay: '0.4s'}}>
                    <div className="text-2xl animate-wiggle">🚀</div>
                    <div>
                      <div className="font-semibold text-slate-800">Startup Speed, Enterprise Quality</div>
                      <div className="text-sm text-slate-600">Move fast, break nothing important</div>
                    </div>
                  </div>
                </div>

                <div className="text-center p-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl text-white animate-fadeInUp" style={{animationDelay: '0.5s'}}>
                  <div className="text-lg font-semibold mb-2">🎯 Ready to build something amazing?</div>
                  <div className="text-sm opacity-90">Let's turn your vision into reality!</div>
                </div>

                <div className="grid grid-cols-2 gap-3 animate-fadeInUp" style={{animationDelay: '0.6s'}}>
                  <a
        ...
        {showInfoModal && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-3xl p-8 max-w-lg w-full shadow-2xl animate-fadeIn">
              <div className="flex justify-between items-start mb-6">
                <h2 className="text-2xl font-bold text-slate-800">🚀 Not Your Boring Portfolio</h2>
                <button
              ...
              <div className="space-y-4 text-slate-600">
                <p className="text-lg">
                  Why settle for static when you can have an <strong>AI-powered conversation</strong> about my journey? 🤖
                </p>
                
                <p>
                  This isn't just another portfolio - it's your personal gateway to discovering what makes me tick as a developer!
                </p>
                
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-purple-500 rounded-full animate-pulse"></div>
                    <span><strong>Next.js 14 & TypeScript</strong> - Because I love type safety ✨</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                    <span><strong>Groq AI Assistant</strong> - Ask me anything, literally! 🧠</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></div>
                    <span><strong>Live GitHub Stars</strong> - Watch the magic happen ⭐</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-yellow-500 rounded-full animate-pulse"></div>
                    <span><strong>Tailwind CSS</strong> - Making pretty things fast 🎨</span>
                  </div>
                </div>

                <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200">
                  <p className="text-sm text-slate-700">
                    <strong>Pro tip:</strong> Try asking the AI about my crypto projects, fintech experience, or that time I handled $1M+ in transactions! 💰
                  </p>
                </div>
